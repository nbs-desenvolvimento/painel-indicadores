...
import type { Area, Role, UserListItem } from "@/lib/apiTypes";
...
interface UsersApi {
  ...
  users: {
    ...
    create: {
      ...
      }) => MutationResult<{ email: string; name?: string; password: string; role: Role; areaIds?: number[] }>;
    };
    update: {
      useMutation: (opts: {
        onSuccess: () => void;
...
const emptyEdit: EditState = { id: null, name: "", email: "", password: "", role: "user", areaIds: new Set() };
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Cadastre usuários e defina as áreas que cada um pode ver e lançar. Administradores têm acesso
            completo, sem restrição de área.
          </p>
        </div>
